...
* Description: Adds some options for the Twenty Seventeen theme.
* Version:     1.0.0
* Author:      Izaac Johansson
...
class izz0_advanced_2017 {
    ...
    */
    public static function register ( $wp_customize ) {
        ...
        $wp_customize->add_control( new WP_Customize_Control(
        $wp_customize,
        'num_for_sections_info_and_link',
        array(
        'type' => 'note',
        )
        ) );
        
        //add_filter('twentyseventeen_front_page_sections', array( __CLASS__, 'num_of_sections_value' ));
    }
  ...
  <?php endif;
    ...
    public static function get_header_logo($text) {
        ...
        if($img != null) {
            ...
            print_r($img_src);
            $dbg = ob_get_clean();
            //wp_die('Image: '.$img.'</br>ID: '.$id.'</br>IMG_SRC: <pre>'.$dbg.'</pre>');
            if(img_src != false)
